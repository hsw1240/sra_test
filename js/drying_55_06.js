	...
	var testLayer1 = new ol.layer.Tile({
		source: new ol.source.TileWMS({
			...
			params: {'LAYERS': 'SRA2017_LC:1985s(LU1980 자료)', 'TILED': true},
	...
	var testLayer2 = new ol.layer.Tile({
		source: new ol.source.TileWMS({
			url: 'http://hygis-server.southeastasia.cloudapp.azure.com:8080/geoserver/SRA2017_LC/wms',
			params: {'LAYERS': 'SRA2017_LC:1995s(LU1990)', 'TILED': true},
			serverType: 'geoserver'
		})
	})
	...
	var testLayer3 = new ol.layer.Tile({
		source: new ol.source.TileWMS({
			url: 'http://hygis-server.southeastasia.cloudapp.azure.com:8080/geoserver/SRA2017_LC/wms',
			params: {'LAYERS': 'SRA2017_LC:2005s(LU2000 자료)', 'TILED': true},
			serverType: 'geoserver'
		})
	})
	...
	var testLayer4 = new ol.layer.Tile({
		source: new ol.source.TileWMS({
			url: 'http://hygis-server.southeastasia.cloudapp.azure.com:8080/geoserver/SRA2017_LC/wms',
			//params: {'LAYERS': 'SRA2017_LC:2015s(LU2013 자료)', 'TILED': true},
			params: {'LAYERS': 'SRA2017_LC:2015s(LU2013 자료)', 'TILED': true},
