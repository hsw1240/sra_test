	var center = [14181053.178283, 4596076.8036719];
	...
	var testLayer1 = new ol.layer.Tile({
		source: new ol.source.TileWMS({
			url: 'http://hygis-server.southeastasia.cloudapp.azure.com:8080/geoserver/SRA2017_FL/wms',
			params: {'LAYERS': 'SRA2017_FL:1976_1985', 'TILED': true},
	...
	var testLayer2 = new ol.layer.Tile({
		source: new ol.source.TileWMS({
			url: 'http://hygis-server.southeastasia.cloudapp.azure.com:8080/geoserver/SRA2017_FL/wms',
			params: {'LAYERS': 'SRA2017_FL:1976_1995', 'TILED': true},
			serverType: 'geoserver'
		})
	})
	...
	var testLayer3 = new ol.layer.Tile({
		source: new ol.source.TileWMS({
			url: 'http://hygis-server.southeastasia.cloudapp.azure.com:8080/geoserver/SRA2017_FL/wms',
			params: {'LAYERS': 'SRA2017_FL:1976_2005', 'TILED': true},
			serverType: 'geoserver'
		})
	})
	...
	var testLayer4 = new ol.layer.Tile({
		source: new ol.source.TileWMS({
			url: 'http://hygis-server.southeastasia.cloudapp.azure.com:8080/geoserver/SRA2017_FL/wms',
			params: {'LAYERS': 'SRA2017_FL:1976_2010', 'TILED': true},
			serverType: 'geoserver'
		})
	})
