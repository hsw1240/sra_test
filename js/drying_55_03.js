	...
	var testLayer1 = new ol.layer.Tile({
		source: new ol.source.TileWMS({
			url: 'http://hygis-server.southeastasia.cloudapp.azure.com:8080/geoserver/SRA2017_FO/wms',
			params: {'LAYERS': 'SRA2017_FO:1985s(h19781980)', 'TILED': true},
	...
	var testLayer2 = new ol.layer.Tile({
		source: new ol.source.TileWMS({
			url: 'http://hygis-server.southeastasia.cloudapp.azure.com:8080/geoserver/SRA2017_FO/wms',
			params: {'LAYERS': 'SRA2017_FO:1995s(h19861992 자료)', 'TILED': true},
			serverType: 'geoserver'
		})
	})
	...
	var testLayer3 = new ol.layer.Tile({
		source: new ol.source.TileWMS({
			url: 'http://hygis-server.southeastasia.cloudapp.azure.com:8080/geoserver/SRA2017_FO/wms',
			params: {'LAYERS': 'SRA2017_FO:2005s(h19962005 자료)', 'TILED': true},
			serverType: 'geoserver'
		})
	})
	...
	var testLayer4 = new ol.layer.Tile({
		source: new ol.source.TileWMS({
			url: 'http://hygis-server.southeastasia.cloudapp.azure.com:8080/geoserver/SRA2017_FO/wms',
			params: {'LAYERS': 'SRA2017_FO:2015s(h20062010 자료)', 'TILED': true},
			serverType: 'geoserver'
		})
	})
