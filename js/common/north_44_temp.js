...
function addFunctionalLayers(whichMap){
	...
	whichMap.addLayer(Basin_tm_polygon_1);
	...
	whichMap.addLayer(Basin_tm_polygon_M);
	...
	*/
	...
	whichMap.addLayer(hydro_rainfall);
	...
	whichMap.addLayer(River_tm_polygon);
	...
	whichMap.addLayer(main_station);
