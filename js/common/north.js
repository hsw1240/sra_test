...
Basin_tm_polygon_1.setVisibility(false);
...
var north_polygon = new OpenLayers.Layer.WMS("접경지역 유역경계",
	'http://1.227.166.166:9133/geoserver/SRA2018_06/wms'

	,{	layers: 'SRA2018_06:north_polygon'

		, transparent:'TRUE',format:'image/png'
	}

	);
north_polygon.setZIndex(900);
map.addLayer(north_polygon);
north_polygon.setVisibility(true);
...
main_station.setVisibility(true);
